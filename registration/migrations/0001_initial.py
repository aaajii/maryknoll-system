    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enrollment_status', models.CharField(choices=[('p', 'Paid'), ('i', 'Incomplete'), ('n', 'Pending'), ('d', 'Dropped out'), ('x', 'Inactive')], default='n', max_length=1)),
                ('school_year', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='enrollment.School_Year')),
                ('section', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='enrollment.Section')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('a', 'Active'), ('x', 'Inactive')], default='x', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='registration.Enrollment')),
                ('scholarship', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='enrollment.Scholarship')),
            ],
            options={
